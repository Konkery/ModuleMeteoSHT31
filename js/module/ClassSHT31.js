...
class ClassSHT31 extends ClassMiddleSensor {
    ...
    constructor(_opts) {
		...
		this._sensor = require('https://github.com/AlexGlgr/ModuleMeteoSHT31/blob/fork-Alexander/js/module/meteo-sensor.min.js').connect({i2c: (new ClassI2CBus).AddBus({sda: _opts._Pins[0], scl: _opts._Pins[1], bitrate: 100000}).IDBus});
